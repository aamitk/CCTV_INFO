                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        ?>
                                          ...
                                          <td><?=$row['la_pro_name']?></td>
                                          <td><?= '<img src="data:image/png;base64,'.base64_encode($row['la_pro_image']).'" width="20%" />' ?></td>
                                          <td>
                ...
                <div class="modal-content"> 
                  ...
                  <div class="modal-footer"> 
                    ...
                    <form class="form-action" action="process.php" method="post">
                      <input type="hidden" name="latestID" id="latestID">
                      <button type="submit" name="latestDel" class="btn btn-primary">Delete</button> 
                    </form>
                  </div> 
                </div> 
              </div> 
